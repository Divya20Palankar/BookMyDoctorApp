...
class ListAppointmentsComponent extends Component {
    constructor(props) {
        super(props)
                              ...
                              this.state.appointments.map(
                                 ...
                                 <TableRow>
                                              ...
                                              <TableCell align="center">
                                                  <Button variant="contained"size="small" color="primary"onClick={ () => this.viewAppointment(appointment.appointmentId)}>Aprove</Button>
                                                  <Button variant="contained"size="small" color="secondary" onClick={ () => this.deleteAppointment(appointment.appointmentId)}>Cancel</Button>
